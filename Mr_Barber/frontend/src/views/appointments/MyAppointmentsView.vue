...
<template>
    <h2 class="text-4xl font-extrabold mt-10" style="color: #D2AC67">Mis Citas</h2>
    ...
    <div v-else>
        <p v-if="user.noAppointments" class="text-2xl text-center mt-5" style="color: #D2AC67">No tienes próximas citas</p>
